...
use crate::network::{ShippingChain, MAX_WAYPOINTS, chains_for_tile};
...
const VEHICLE_LENGTH: f32 = 1400.0;
const VEHICLE_WIDTH: f32 = 180.0;
const VEHICLE_HEIGHT: f32 = 220.0;
...
fn generate_tile_instances(coordinate: TileCoordinate, chains: &[ShippingChain]) -> Vec<InstanceData> {
