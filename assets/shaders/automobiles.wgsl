...
// automobiles live at the same fixed highest LOD as buildings, so they fade out over the same
...
fn vertex(input: VertexInput) -> VertexOutput {
    ...
    // Reverse-direction automobiles walk the same waypoint path back-to-front, so they visually
